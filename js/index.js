...
(function () {
  ...
  async function inicioSesion(e) {
    ...
    if ([email.value,password.value].includes("")) {
      setAlerta("Los Campos son Obligatorios", true);
      return;
    }

    const div = document.createElement("div");
      div.innerHTML = `<div role="status" class="flex justify-center">
            <svg class="inline mr-2 mt-10 w-10 h-10  text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
